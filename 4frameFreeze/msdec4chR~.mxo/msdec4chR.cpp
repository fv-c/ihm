...
Compilation options: -a /usr/local/share/faust/max-msp/max-msp64.cpp -lang cpp -i -ct 1 -cn msdec4chR -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0
------------------------------------------------------------ */

#ifndef  __msdec4chR_H__
#define  __msdec4chR_H__
...
class msdec4chR : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /usr/local/share/faust/max-msp/max-msp64.cpp -lang cpp -i -ct 1 -cn msdec4chR -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0");
		m->declare("filename", "msdec4chR.dsp");
		m->declare("maths.lib/author", "GRAME");
		m->declare("maths.lib/copyright", "GRAME");
		m->declare("maths.lib/license", "LGPL with exception");
		m->declare("maths.lib/name", "Faust Math Library");
		m->declare("maths.lib/version", "2.8.0");
		m->declare("name", "msdec4chR");
	}
	...
	virtual msdec4chR* clone() {
		return new msdec4chR();
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("msdec4chR");
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			double fTemp2 = 0.7071067811865475 * fTemp1;
			output0[i0] = FAUSTFLOAT(0.7071067811865476 * fTemp0 + fTemp2);
			output1[i0] = FAUSTFLOAT(0.7071067811865476 * fTemp1 - 0.7071067811865475 * fTemp0);
			output2[i0] = FAUSTFLOAT(-(fTemp2 + 0.7071067811865477 * fTemp0));
			output3[i0] = FAUSTFLOAT(0.7071067811865474 * fTemp0 - 0.7071067811865477 * fTemp1);
		}
	}
 ...
 */
class msdec4chR_poly : public dsp_voice_group, public dsp_poly {
    ...
    private:
        ...
        {
            if (val == FAUSTFLOAT(1)) {
                static_cast<msdec4chR_poly*>(arg)->allNotesOff(true);
            }
        }
    ...
    public:
         ...
         * Constructor.
         *
         * @param dsp - the dsp to be used for one voice. Beware: msdec4chR_poly will use and finally delete the pointer.
        ...
        virtual msdec4chR_poly* clone()
        {
            return new msdec4chR_poly(fDSP->clone(), int(fVoiceTable.size()), fVoiceControl, fGroupControl);
        }
...
struct dsp_poly_factory : public dsp_factory {
    ...
    dsp_poly* createPolyDSPInstance(int nvoices, bool control, bool group, bool is_double = false)
    {
        ...
        dsp_poly* dsp_poly = new msdec4chR_poly(adaptDSP(fProcessFactory->createDSPInstance(), is_double), nvoices, control, group);
        if (fEffectFactory) {
...
void faust_allocate(t_faust* x, int nvoices)
{
    ...
    if (nvoices > 0) {
    ...
    #endif
        x->m_dsp = new msdec4chR_poly(new msdec4chR(), nvoices, true, true);
    #ifdef POLY2
        ...
        std::string error;
        x->m_dsp = createSRAdapter<FAUSTFLOAT>(new msdec4chR(), error, DOWN_SAMPLING, UP_SAMPLING, FILTER_TYPE);
    }
...
void* faust_new(t_symbol* s, short ac, t_atom* av)
{
    ...
    msdec4chR* tmp_dsp = new msdec4chR();
