...
Compilation options: -a /usr/local/share/faust/max-msp/max-msp64.cpp -lang cpp -i -ct 1 -cn sig2FiveStoneC -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0
------------------------------------------------------------ */

#ifndef  __sig2FiveStoneC_H__
#define  __sig2FiveStoneC_H__
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS sig2FiveStoneC
#endif
...
static double sig2FiveStoneC_faustpower2_f(double value) {
	return value * value;
}

class sig2FiveStoneC : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		m->declare("author", "Francesco Vitucci");
		m->declare("basics.lib/name", "Faust Basic Element Library");
		m->declare("basics.lib/tabulateNd", "Copyright (C) 2023 Bart Brouns <bart@magnetophon.nl>");
		m->declare("basics.lib/version", "1.15.0");
		m->declare("compile_options", "-a /usr/local/share/faust/max-msp/max-msp64.cpp -lang cpp -i -ct 1 -cn sig2FiveStoneC -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0");
		m->declare("delays.lib/name", "Faust Delay Library");
		m->declare("delays.lib/version", "1.1.0");
		m->declare("filename", "sig2FiveStoneC.dsp");
		m->declare("maths.lib/author", "GRAME");
		m->declare("maths.lib/copyright", "GRAME");
		m->declare("maths.lib/license", "LGPL with exception");
		m->declare("maths.lib/name", "Faust Math Library");
		m->declare("maths.lib/version", "2.8.0");
		m->declare("name", "sig2FiveStoneC");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst2 = 1.0 - fConst1;
		fConst3 = 0.0029411764705882353 * fConst0;
	}
	
	virtual void instanceResetUserInterface() {
		fHslider0 = FAUSTFLOAT(11.0);
	...
	virtual sig2FiveStoneC* clone() {
		return new sig2FiveStoneC();
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("sig2FiveStoneC");
		ui_interface->addHorizontalSlider("sigX", &fHslider0, FAUSTFLOAT(11.0), FAUSTFLOAT(1.0), FAUSTFLOAT(15.0), FAUSTFLOAT(0.001));
		ui_interface->addHorizontalSlider("sigY", &fHslider1, FAUSTFLOAT(0.0), FAUSTFLOAT(-8.0), FAUSTFLOAT(8.0), FAUSTFLOAT(0.001));
		ui_interface->addHorizontalSlider("sigZ", &fHslider2, FAUSTFLOAT(0.0), FAUSTFLOAT(-16.0), FAUSTFLOAT(16.0), FAUSTFLOAT(0.001));
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			double fTemp1 = sig2FiveStoneC_faustpower2_f(fRec0[0] + -7.3);
			fRec1[0] = fSlow1 + fConst2 * fRec1[1];
			fRec2[0] = fSlow2 + fConst2 * fRec2[1];
			double fTemp2 = sig2FiveStoneC_faustpower2_f(fRec2[0]);
			double fTemp3 = std::sqrt(fTemp1 + sig2FiveStoneC_faustpower2_f(fRec1[0] + 6.7) + fTemp2);
			fVec0[IOTA0 & 262143] = fTemp0 * std::pow(1e+01, -0.55 * std::log10(std::max<double>(fTemp3, 1.0)));
			double fTemp4 = fVec0[(IOTA0 - int(std::min<double>(fConst0, std::max<double>(0.0, fConst3 * fTemp3)))) & 262143];
			double fTemp5 = sig2FiveStoneC_faustpower2_f(fRec0[0] - 7.3);
			double fTemp6 = std::sqrt(fTemp5 + fTemp2);
			int iTemp7 = ((fTemp6 == 0.0) ? 1 : 0);
			double fTemp8 = 7.3 - fRec0[0];
			double fTemp9 = ((fTemp6 < 0.0) ? fTemp6 : std::max<double>(fTemp6, 0.0001));
			double fTemp10 = ((iTemp7) ? 0.0 : -(fTemp8 / fTemp9));
			double fTemp11 = std::sqrt(sig2FiveStoneC_faustpower2_f(fTemp10) + sig2FiveStoneC_faustpower2_f(((iTemp7) ? 0.0 : fRec2[0] / fTemp9)));
			double fTemp12 = ((fTemp11 == 0.0) ? 0.0 : fTemp10 / ((fTemp11 < 0.0) ? fTemp11 : std::max<double>(fTemp11, 0.0001)));
			double fTemp13 = double((((-7.3 * fRec2[0]) < 0.0) ? 1 : -1)) * ((fTemp12 == 0.0) ? 0.0 : std::acos(((fTemp12 < 0.0) ? fTemp12 : std::max<double>(fTemp12, 0.0001))));
			double fTemp14 = std::sin(fTemp13);
			double fTemp15 = std::cos(fTemp13);
			double fTemp16 = 6.7 * fRec0[0];
			double fTemp17 = 7.3 * fRec1[0];
			double fTemp18 = std::sqrt(fTemp5 + sig2FiveStoneC_faustpower2_f(fRec1[0] - -6.7));
			int iTemp19 = ((fTemp18 == 0.0) ? 1 : 0);
			double fTemp20 = ((fTemp18 < 0.0) ? fTemp18 : std::max<double>(fTemp18, 0.0001));
			double fTemp21 = ((iTemp19) ? 0.0 : -(fTemp8 / fTemp20));
			double fTemp22 = ((iTemp19) ? 0.0 : -((-6.7 - fRec1[0]) / fTemp20));
			double fTemp23 = std::sqrt(sig2FiveStoneC_faustpower2_f(fTemp21) + sig2FiveStoneC_faustpower2_f(fTemp22));
			double fTemp24 = ((fTemp23 == 0.0) ? 0.0 : (0.7367350744830315 * fTemp21 - 0.6761815067173029 * fTemp22) / ((fTemp23 < 0.0) ? fTemp23 : std::max<double>(fTemp23, 0.0001)));
			double fTemp25 = double(((-(fTemp16 + fTemp17) < 0.0) ? -1 : 1)) * ((fTemp24 == 0.0) ? 0.0 : std::acos(((fTemp24 < 0.0) ? fTemp24 : std::max<double>(fTemp24, 0.0001))));
			double fTemp26 = std::sin(fTemp25);
			double fTemp27 = std::cos(fTemp25);
			double fTemp28 = fTemp15 * (fTemp26 + fTemp27);
			output0[i0] = FAUSTFLOAT(0.5 * fTemp4 * (fTemp14 + fTemp28 + 1.0));
			double fTemp29 = fTemp15 * (fTemp26 - fTemp27);
			output1[i0] = FAUSTFLOAT(0.5 * fTemp4 * (1.0 - (fTemp14 + fTemp29)));
			double fTemp30 = -1.0 - fTemp14;
			output2[i0] = FAUSTFLOAT(-0.5 * fTemp4 * (fTemp28 + fTemp30));
			output3[i0] = FAUSTFLOAT(-0.5 * fTemp4 * (fTemp14 + (-1.0 - fTemp29)));
			double fTemp31 = fTemp2 + sig2FiveStoneC_faustpower2_f(fRec0[0] + -9.3);
			double fTemp32 = std::sqrt(sig2FiveStoneC_faustpower2_f(fRec1[0] + 3.6) + fTemp31);
			fVec1[IOTA0 & 262143] = fTemp0 * std::pow(1e+01, -0.55 * std::log10(std::max<double>(fTemp32, 1.0)));
			double fTemp33 = fVec1[(IOTA0 - int(std::min<double>(fConst0, std::max<double>(0.0, fConst3 * fTemp32)))) & 262143];
			double fTemp34 = sig2FiveStoneC_faustpower2_f(fRec0[0] - 9.3);
			double fTemp35 = std::sqrt(fTemp34 + fTemp2);
			int iTemp36 = ((fTemp35 == 0.0) ? 1 : 0);
			double fTemp37 = 9.3 - fRec0[0];
			double fTemp38 = ((fTemp35 < 0.0) ? fTemp35 : std::max<double>(fTemp35, 0.0001));
			double fTemp39 = ((iTemp36) ? 0.0 : -(fTemp37 / fTemp38));
			double fTemp40 = std::sqrt(sig2FiveStoneC_faustpower2_f(fTemp39) + sig2FiveStoneC_faustpower2_f(((iTemp36) ? 0.0 : fRec2[0] / fTemp38)));
			double fTemp41 = ((fTemp40 == 0.0) ? 0.0 : fTemp39 / ((fTemp40 < 0.0) ? fTemp40 : std::max<double>(fTemp40, 0.0001)));
			double fTemp42 = double((((-9.3 * fRec2[0]) < 0.0) ? 1 : -1)) * ((fTemp41 == 0.0) ? 0.0 : std::acos(((fTemp41 < 0.0) ? fTemp41 : std::max<double>(fTemp41, 0.0001))));
			double fTemp43 = std::sin(fTemp42);
			double fTemp44 = std::cos(fTemp42);
			double fTemp45 = 3.6 * fRec0[0];
			double fTemp46 = 9.3 * fRec1[0];
			double fTemp47 = std::sqrt(fTemp34 + sig2FiveStoneC_faustpower2_f(fRec1[0] - -3.6));
			int iTemp48 = ((fTemp47 == 0.0) ? 1 : 0);
			double fTemp49 = ((fTemp47 < 0.0) ? fTemp47 : std::max<double>(fTemp47, 0.0001));
			double fTemp50 = ((iTemp48) ? 0.0 : -(fTemp37 / fTemp49));
			double fTemp51 = ((iTemp48) ? 0.0 : -((-3.6 - fRec1[0]) / fTemp49));
			double fTemp52 = std::sqrt(sig2FiveStoneC_faustpower2_f(fTemp50) + sig2FiveStoneC_faustpower2_f(fTemp51));
			double fTemp53 = ((fTemp52 == 0.0) ? 0.0 : (0.9325680982740896 * fTemp50 - 0.3609941025577121 * fTemp51) / ((fTemp52 < 0.0) ? fTemp52 : std::max<double>(fTemp52, 0.0001)));
			double fTemp54 = double(((-(fTemp45 + fTemp46) < 0.0) ? -1 : 1)) * ((fTemp53 == 0.0) ? 0.0 : std::acos(((fTemp53 < 0.0) ? fTemp53 : std::max<double>(fTemp53, 0.0001))));
			double fTemp55 = std::sin(fTemp54);
			double fTemp56 = std::cos(fTemp54);
			double fTemp57 = fTemp44 * (fTemp55 + fTemp56);
			output4[i0] = FAUSTFLOAT(0.5 * fTemp33 * (fTemp43 + fTemp57 + 1.0));
			double fTemp58 = fTemp44 * (fTemp55 - fTemp56);
			output5[i0] = FAUSTFLOAT(0.5 * fTemp33 * (1.0 - (fTemp43 + fTemp58)));
			double fTemp59 = -1.0 - fTemp43;
			output6[i0] = FAUSTFLOAT(-0.5 * fTemp33 * (fTemp57 + fTemp59));
			output7[i0] = FAUSTFLOAT(-0.5 * fTemp33 * (fTemp43 + (-1.0 - fTemp58)));
			double fTemp60 = sig2FiveStoneC_faustpower2_f(fRec1[0]);
			double fTemp61 = std::sqrt(fTemp60 + fTemp2 + sig2FiveStoneC_faustpower2_f(fRec0[0] + -1e+01));
			fVec2[IOTA0 & 262143] = fTemp0 * std::pow(1e+01, -0.55 * std::log10(std::max<double>(fTemp61, 1.0)));
			double fTemp62 = fVec2[(IOTA0 - int(std::min<double>(fConst0, std::max<double>(0.0, fConst3 * fTemp61)))) & 262143];
			double fTemp63 = sig2FiveStoneC_faustpower2_f(fRec0[0] - 1e+01);
			double fTemp64 = std::sqrt(fTemp63 + fTemp2);
			int iTemp65 = ((fTemp64 == 0.0) ? 1 : 0);
			double fTemp66 = 1e+01 - fRec0[0];
			double fTemp67 = ((fTemp64 < 0.0) ? fTemp64 : std::max<double>(fTemp64, 0.0001));
			double fTemp68 = ((iTemp65) ? 0.0 : -(fTemp66 / fTemp67));
			double fTemp69 = std::sqrt(sig2FiveStoneC_faustpower2_f(fTemp68) + sig2FiveStoneC_faustpower2_f(((iTemp65) ? 0.0 : fRec2[0] / fTemp67)));
			double fTemp70 = ((fTemp69 == 0.0) ? 0.0 : fTemp68 / ((fTemp69 < 0.0) ? fTemp69 : std::max<double>(fTemp69, 0.0001)));
			double fTemp71 = double((((-1e+01 * fRec2[0]) < 0.0) ? 1 : -1)) * ((fTemp70 == 0.0) ? 0.0 : std::acos(((fTemp70 < 0.0) ? fTemp70 : std::max<double>(fTemp70, 0.0001))));
			double fTemp72 = std::sin(fTemp71);
			double fTemp73 = std::cos(fTemp71);
			double fTemp74 = std::sqrt(fTemp63 + fTemp60);
			int iTemp75 = ((fTemp74 == 0.0) ? 1 : 0);
			double fTemp76 = ((fTemp74 < 0.0) ? fTemp74 : std::max<double>(fTemp74, 0.0001));
			double fTemp77 = ((iTemp75) ? 0.0 : -(fTemp66 / fTemp76));
			double fTemp78 = std::sqrt(sig2FiveStoneC_faustpower2_f(fTemp77) + sig2FiveStoneC_faustpower2_f(((iTemp75) ? 0.0 : fRec1[0] / fTemp76)));
			double fTemp79 = ((fTemp78 == 0.0) ? 0.0 : fTemp77 / ((fTemp78 < 0.0) ? fTemp78 : std::max<double>(fTemp78, 0.0001)));
			double fTemp80 = double((((-1e+01 * fRec1[0]) < 0.0) ? -1 : 1)) * ((fTemp79 == 0.0) ? 0.0 : std::acos(((fTemp79 < 0.0) ? fTemp79 : std::max<double>(fTemp79, 0.0001))));
			double fTemp81 = std::sin(fTemp80);
			double fTemp82 = std::cos(fTemp80);
			double fTemp83 = fTemp73 * (fTemp81 + fTemp82);
			output8[i0] = FAUSTFLOAT(0.5 * fTemp62 * (fTemp72 + fTemp83 + 1.0));
			double fTemp84 = fTemp73 * (fTemp81 - fTemp82);
			output9[i0] = FAUSTFLOAT(0.5 * fTemp62 * (1.0 - (fTemp72 + fTemp84)));
			output10[i0] = FAUSTFLOAT(-0.5 * fTemp62 * (fTemp83 + (-1.0 - fTemp72)));
			output11[i0] = FAUSTFLOAT(-0.5 * fTemp62 * (fTemp72 + (-1.0 - fTemp84)));
			double fTemp85 = std::sqrt(fTemp31 + sig2FiveStoneC_faustpower2_f(fRec1[0] + -3.6));
			fVec3[IOTA0 & 262143] = fTemp0 * std::pow(1e+01, -0.55 * std::log10(std::max<double>(fTemp85, 1.0)));
			double fTemp86 = fVec3[(IOTA0 - int(std::min<double>(fConst0, std::max<double>(0.0, fConst3 * fTemp85)))) & 262143];
			double fTemp87 = std::sqrt(fTemp34 + sig2FiveStoneC_faustpower2_f(fRec1[0] - 3.6));
			int iTemp88 = ((fTemp87 == 0.0) ? 1 : 0);
			double fTemp89 = ((fTemp87 < 0.0) ? fTemp87 : std::max<double>(fTemp87, 0.0001));
			double fTemp90 = ((iTemp88) ? 0.0 : -(fTemp37 / fTemp89));
			double fTemp91 = ((iTemp88) ? 0.0 : -((3.6 - fRec1[0]) / fTemp89));
			double fTemp92 = std::sqrt(sig2FiveStoneC_faustpower2_f(fTemp90) + sig2FiveStoneC_faustpower2_f(fTemp91));
			double fTemp93 = ((fTemp92 == 0.0) ? 0.0 : (0.9325680982740896 * fTemp90 + 0.3609941025577121 * fTemp91) / ((fTemp92 < 0.0) ? fTemp92 : std::max<double>(fTemp92, 0.0001)));
			double fTemp94 = double((((fTemp45 - fTemp46) < 0.0) ? -1 : 1)) * ((fTemp93 == 0.0) ? 0.0 : std::acos(((fTemp93 < 0.0) ? fTemp93 : std::max<double>(fTemp93, 0.0001))));
			double fTemp95 = std::sin(fTemp94);
			double fTemp96 = std::cos(fTemp94);
			double fTemp97 = fTemp44 * (fTemp95 + fTemp96);
			output12[i0] = FAUSTFLOAT(0.5 * fTemp86 * (fTemp43 + fTemp97 + 1.0));
			double fTemp98 = fTemp44 * (fTemp95 - fTemp96);
			output13[i0] = FAUSTFLOAT(0.5 * fTemp86 * (1.0 - (fTemp43 + fTemp98)));
			output14[i0] = FAUSTFLOAT(-0.5 * fTemp86 * (fTemp97 + fTemp59));
			output15[i0] = FAUSTFLOAT(-0.5 * fTemp86 * (fTemp43 + (-1.0 - fTemp98)));
			double fTemp99 = std::sqrt(sig2FiveStoneC_faustpower2_f(fRec1[0] + -6.7) + fTemp1 + fTemp2);
			fVec4[IOTA0 & 262143] = fTemp0 * std::pow(1e+01, -0.55 * std::log10(std::max<double>(fTemp99, 1.0)));
			double fTemp100 = fVec4[(IOTA0 - int(std::min<double>(fConst0, std::max<double>(0.0, fConst3 * fTemp99)))) & 262143];
			double fTemp101 = std::sqrt(fTemp5 + sig2FiveStoneC_faustpower2_f(fRec1[0] - 6.7));
			int iTemp102 = ((fTemp101 == 0.0) ? 1 : 0);
			double fTemp103 = ((fTemp101 < 0.0) ? fTemp101 : std::max<double>(fTemp101, 0.0001));
			double fTemp104 = ((iTemp102) ? 0.0 : -(fTemp8 / fTemp103));
			double fTemp105 = ((iTemp102) ? 0.0 : -((6.7 - fRec1[0]) / fTemp103));
			double fTemp106 = std::sqrt(sig2FiveStoneC_faustpower2_f(fTemp104) + sig2FiveStoneC_faustpower2_f(fTemp105));
			double fTemp107 = ((fTemp106 == 0.0) ? 0.0 : (0.7367350744830315 * fTemp104 + 0.6761815067173029 * fTemp105) / ((fTemp106 < 0.0) ? fTemp106 : std::max<double>(fTemp106, 0.0001)));
			double fTemp108 = double((((fTemp16 - fTemp17) < 0.0) ? -1 : 1)) * ((fTemp107 == 0.0) ? 0.0 : std::acos(((fTemp107 < 0.0) ? fTemp107 : std::max<double>(fTemp107, 0.0001))));
			double fTemp109 = std::sin(fTemp108);
			double fTemp110 = std::cos(fTemp108);
			double fTemp111 = fTemp15 * (fTemp109 + fTemp110);
			output16[i0] = FAUSTFLOAT(0.5 * fTemp100 * (fTemp14 + fTemp111 + 1.0));
			double fTemp112 = fTemp15 * (fTemp109 - fTemp110);
			output17[i0] = FAUSTFLOAT(0.5 * fTemp100 * (1.0 - (fTemp14 + fTemp112)));
			output18[i0] = FAUSTFLOAT(-0.5 * fTemp100 * (fTemp111 + fTemp30));
			output19[i0] = FAUSTFLOAT(-0.5 * fTemp100 * (fTemp14 + (-1.0 - fTemp112)));
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			fRec2[1] = fRec2[0];
			IOTA0 = IOTA0 + 1;
 ...
 */
class sig2FiveStoneC_poly : public dsp_voice_group, public dsp_poly {
    ...
    private:
        ...
        {
            if (val == FAUSTFLOAT(1)) {
                static_cast<sig2FiveStoneC_poly*>(arg)->allNotesOff(true);
            }
        }
    ...
    public:
         ...
         * Constructor.
         *
         * @param dsp - the dsp to be used for one voice. Beware: sig2FiveStoneC_poly will use and finally delete the pointer.
        ...
        virtual sig2FiveStoneC_poly* clone()
        {
            return new sig2FiveStoneC_poly(fDSP->clone(), int(fVoiceTable.size()), fVoiceControl, fGroupControl);
        }
...
struct dsp_poly_factory : public dsp_factory {
    ...
    dsp_poly* createPolyDSPInstance(int nvoices, bool control, bool group, bool is_double = false)
    {
        ...
        dsp_poly* dsp_poly = new sig2FiveStoneC_poly(adaptDSP(fProcessFactory->createDSPInstance(), is_double), nvoices, control, group);
        if (fEffectFactory) {
...
void faust_allocate(t_faust* x, int nvoices)
{
    ...
    if (nvoices > 0) {
    ...
    #endif
        x->m_dsp = new sig2FiveStoneC_poly(new sig2FiveStoneC(), nvoices, true, true);
    #ifdef POLY2
        ...
        std::string error;
        x->m_dsp = createSRAdapter<FAUSTFLOAT>(new sig2FiveStoneC(), error, DOWN_SAMPLING, UP_SAMPLING, FILTER_TYPE);
    }
...
void* faust_new(t_symbol* s, short ac, t_atom* av)
{
    ...
    sig2FiveStoneC* tmp_dsp = new sig2FiveStoneC();
...
#endif
{
    ...
    dsp* tmp_dsp = new sig2FiveStoneC();
    mspUI tmp_UI;
